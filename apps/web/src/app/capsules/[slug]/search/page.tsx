  ...
  return (
    <div className="space-y-8">
      <div className="border-b border-[#DCD6CB] pb-4">
        ...
        <h1 className="font-serif text-3xl md:text-4xl text-[#1D1C1A] mt-2">Search Memories & Media</h1>
        <p className="text-xs md:text-sm text-[#5D5A54] mt-1">
          Search class memories by keyword, classmate name, story title, or tag.
        </p>
      </div>

      <ContentCollection viewMode="search" />
    </div>
  );
}
